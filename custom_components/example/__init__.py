...
from .example_hub import HelloWorld
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    coordinator = ExampleDataUpdateCoordinator(hass, host=host, api_key=api_key)
...
class ExampleDataUpdateCoordinator(DataUpdateCoordinator):
    """Class to manage fetching data from Examples."""
    ...
    async def _async_update_data(self):
        ...
        _LOGGER.debug(f'update from Examples: {self._api.data}')
